...
VALID_DESTINATION_TYPES = {
    ...
    "education_city", "food_city", "craft_city", "lake_heritage_city", "desert_town",
    "hill_station", "lake_hill_station", "hill_town", "hill_region", "mountain_town", "mountain_region", "mountain_resort",
    "high_altitude", "valley", "lake_city", "lake_region", "lake_valley", "river_town", "river_region", "river_spiritual_town",
    ...
    "coastal_region", "coastal_capital", "coastal_heritage_city", "coastal_heritage_town", "metro_coastal_city",
    "island_gateway", "island_beach", "island_region", "island_resort", "local_island", "river_island", "marine_region",
