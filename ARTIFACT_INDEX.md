...
| Master validation script | `src/codemike/data/destination_master_validation.py` | Validates master CSV against master schema | Active; needs Termux run |
...
| Master v2 validation report | `reports/evidence/destination-master-v2-validation-report.md` | Scaffold; needs run | Will be generated by master validation script |
...
- Master validation report needs computed rerun.
- HTML QA browser for master records does not exist yet.
